export const ES_TEXT = {
  ...
  guards: {
    ...
    table: {
      ...
      tariffsAria: "Tarifas de {name}",
      weaponsButton: "Armas",
      weaponsAria: "Gestionar armas de {name}",
      notesButton: "Notas",
      notesAria: "Ver notas de {name}",
      addNoteButton: "Agregar nota",
      addNoteAria: "Agregar nota para {name}",
      whatsappTitle: "Abrir en WhatsApp",
      whatsappAria: "Abrir chat de WhatsApp con {phone}",
    },
  ...
  notes: {
    ...
    list: {
      ...
      headers: {
        ...
        shifts: "Turnos",
        weapons: "Armas",
        typeOfServices: "Tipo(s) de Servicio",
        viewedBy: "Visto por",
        actions: "Acciones",
      },
      actionEdit: "Editar {name}",
    ...
    create: {
      ...
      addAmountAria: "Agregar nueva entrada de monto",
      removeAmountAria: "Eliminar entrada de monto",
      amountPlaceholder: "p.ej. 100.50 o -15",
      amountsHelp: "Puedes agregar múltiples montos (positivos o negativos). Se sumarán y el total final se enviará al backend.",
      totalLabel: "Total",
      fields: {
        name: "Nombre",
        description: "Descripción",
        ...
        shifts: "Turnos",
        weapons: "Armas",
        type_of_services: "Tipo de Servicio",
      },
      buttons: {
        add: "Agregar",
        create: "Crear",
      ...
      help: {
        amountsSummary: "Ejemplo: agregar 15, -15, 25 da como total 25 (eso es lo que se enviará al backend).",
      },
    },
    edit: {
      title: "Editar Nota",
    ...
    delete: {
      title: "Eliminar Nota",
      confirm: "¿Estás seguro que quieres eliminar la nota \"{name}\"?",
    },
    errors: {
