 ...
 weapons: {
  ...
  guards: {
    ...
    table: {
      ...
      tariffsAria: "Tariffs for {name}",
      weaponsButton: "Weapons",
      weaponsAria: "Manage weapons for {name}",
      notesButton: "Notes",
      notesAria: "View notes for {name}",
      addNoteButton: "Add note",
      addNoteAria: "Add note for {name}",
      whatsappTitle: "Open in WhatsApp",
      whatsappAria: "Open WhatsApp chat with {phone}",
    },
